...
def write_para(instance_name, method, para_filename, opt_value, max_trials=1000):
    with open(para_filename, "w") as f:
        f.write("PROBLEM_FILE = gh_data/" + instance_name + ".vrptw\n")
        f.write("MAX_TRIALS = " + str(max_trials) + "\n")
        f.write("SPECIAL\nRUNS = 1\n")
        f.write("OPTIMUM = " + str(opt_value) + "\n")
        if method == "NeuroLKH":
            f.write("SEED = 1234\n")
            f.write("CANDIDATE_FILE = result/gh_cvrptw_not/candidate/" + instance_name + ".txt\n")
...
def solve_LKH(instance_name, opt_value, rerun=False, max_trials=1000):
    para_filename = "result/gh_cvrptw_not/LKH_para/" + instance_name + ".para"
    log_filename = "result/gh_cvrptw_not/LKH_log/" + instance_name + ".log"
...
def infer_SGN_write_candidate(net, instance_names):
    for instance_name in instance_names:
        with open("gh_data/" + instance_name + ".vrptw", "r") as f:
            lines = f.readlines()
            ...
            for i in range(n_nodes):
                line = [int(_) for _ in lines[9 + n_nodes + i].strip().split()]
                assert len(line) == 2
                assert line[0] == i + 1
                demand[:,i] = line[1]
            ...
            for i in range(n_nodes):
                line = [float(_) for _ in lines[10 + n_nodes*2 + i].strip().split()]
                assert len(line) == 3
                assert line[0] == i + 1
                start.append([line[1]])
                end.append(line[2])
        ...
        with open("result/gh_cvrptw_not/candidate/" + instance_name + ".txt", "w") as f:
...
def solve_NeuroLKH(instance_name, opt_value, rerun=False, max_trials=1000):
    para_filename = "result/gh_cvrptw_not/NeuroLKH_para/" + instance_name + ".para"
    log_filename = "result/gh_cvrptw_not/NeuroLKH_log/" + instance_name + ".log"
    if rerun or not os.path.isfile(log_filename):
...
def eval_dataset(instance_names, method, args, opt_values, rerun=True, max_trials=1000):
    os.makedirs("result/gh_cvrptw_not/" + method + "_para", exist_ok=True)
    os.makedirs("result/gh_cvrptw_not/" + method + "_log", exist_ok=True)
    if method == "NeuroLKH":
        os.makedirs("result/gh_cvrptw_not/candidate", exist_ok=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='pretrained/55.pt', help='')
    parser.add_argument('--n_samples', type=int, default=35, help='')
    ...
    instance_names = "R1_2_1.200.20 R1_2_2.200.18 R1_2_3.200.18 R1_2_4.200.18 R1_2_5.200.18 R1_2_6.200.18 R1_2_7.200.18 R1_2_8.200.18 R1_2_9.200.18 R1_2_10.200.18 RC1_2_1.200.18 RC1_2_2.200.18 RC1_2_3.200.18 RC1_2_4.200.18 RC1_2_5.200.18 RC1_2_6.200.18 RC1_2_7.200.18 RC1_2_8.200.18 RC1_2_9.200.18 RC1_2_10.200.18 R1_4_1.400.40 R1_4_2.400.36 R1_4_3.400.36 R1_4_4.400.36 R1_4_5.400.36 R1_4_6.400.36 R1_4_7.400.36 R1_4_8.400.36 R1_4_9.400.36 R1_4_10.400.36 RC1_4_1.400.36 RC1_4_2.400.36 RC1_4_3.400.36 RC1_4_4.400.36 RC1_4_5.400.36 RC1_4_6.400.36 RC1_4_7.400.36 RC1_4_8.400.36 RC1_4_9.400.36 RC1_4_10.400.36 R1_6_1.600.59 R1_6_2.600.54 R1_6_3.600.54 R1_6_4.600.54 R1_6_5.600.54 R1_6_6.600.54 R1_6_7.600.54 R1_6_8.600.54 R1_6_9.600.54 R1_6_10.600.54 RC1_6_1.600.55 RC1_6_2.600.55 RC1_6_3.600.55 RC1_6_4.600.55 RC1_6_5.600.55 RC1_6_6.600.55 RC1_6_7.600.55 RC1_6_8.600.55 RC1_6_9.600.55 RC1_6_10.600.55 R1_8_1.800.80 R1_8_2.800.72 R1_8_3.800.72 R1_8_4.800.72 R1_8_5.800.72 R1_8_6.800.72 R1_8_7.800.72 R1_8_8.800.72 R1_8_9.800.72 R1_8_10.800.72 RC1_8_1.800.72 RC1_8_2.800.72 RC1_8_3.800.72 RC1_8_4.800.72 RC1_8_5.800.72 RC1_8_6.800.72 RC1_8_7.800.72 RC1_8_8.800.72 RC1_8_9.800.72 RC1_8_10.800.72 R1_10_1.1000.100 R1_10_2.1000.91 R1_10_3.1000.91 R1_10_4.1000.91 R1_10_5.1000.91 R1_10_6.1000.91 R1_10_7.1000.91 R1_10_8.1000.91 R1_10_9.1000.91 R1_10_10.1000.91 RC1_10_1.1000.90 RC1_10_2.1000.90 RC1_10_3.1000.90 RC1_10_4.1000.90 RC1_10_5.1000.90 RC1_10_6.1000.90 RC1_10_7.1000.90 RC1_10_8.1000.90 RC1_10_9.1000.90 RC1_10_10.1000.90"
    instance_names = instance_names.split(" ")[:args.n_samples]
    with open("gh_data/opt.pkl", "rb") as f:
