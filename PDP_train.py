...
parser.add_argument('--file_path', default='PDP_train', help='')
parser.add_argument('--eval_file_path', default='PDP_val', help='')
...
while epoch < args.n_epoch:
    ...
    net.train()
    dataset_index = epoch % 5
    dataLoader.load_data(2 * dataset_index)
    ...
    if epoch % args.eval_interval == 0:
        ...
        print ("n=40 %.3f %.3f, n=80 %.3f %.3f, n=200 %.3f %.3f" % (tuple(eval_results)))
